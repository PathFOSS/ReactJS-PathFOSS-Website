...
const AboutSection = () => {
    return <section id="about">
        ...
        <p className="paragraph">My name is Patrick and I go by PathFOSS on GitHub. I am a hobbyist developer with love for UI/UX and Android.</p>
        ...
        <p className="paragraph">I am open to new job opportunities so do not hesitate to contact me by email.</p>
